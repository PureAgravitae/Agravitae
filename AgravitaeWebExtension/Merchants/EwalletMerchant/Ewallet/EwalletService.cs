...
namespace AgravitaeWebExtension.Merchants.EwalletMerchant.Ewallet
{
    public interface IEwalletService
    {
        ...
        string CreateToken();
        PaymentResponse CreditPayment(string payorId, int orderNumber, string currencyCode, decimal paymentAmount, decimal refundAmount, string cardNumber, string transactionNumber, string authorizationCode, string discoNotes, string batchId, string source);
    ...
    public class EwalletService : IEwalletService
    {
        ...
        public PaymentResponse CreditPayment(string payorId, int orderNumber, string currencyCode, decimal paymentAmount, decimal refundAmount, string cardNumber, string transactionNumber, string authorizationCode, string discoNotes, string batchId, string source)
        {
